...
public class ContainerThaumonomicon extends Container
{
    private final IInventory hopperInventory;

    public ContainerThaumonomicon(ContainerType<?> containerType, int p_i50078_1_, PlayerInventory p_i50078_2_) {
        this(containerType, p_i50078_1_, p_i50078_2_, new Inventory(5));
    }

    public ContainerThaumonomicon(ContainerType<?> containerType, int p_i50079_1_, PlayerInventory p_i50079_2_, IInventory p_i50079_3_) {
        super(containerType, p_i50079_1_);
