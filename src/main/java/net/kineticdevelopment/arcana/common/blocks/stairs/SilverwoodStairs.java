package net.kineticdevelopment.arcana.common.blocks.stairs;
...
public class SilverwoodStairs extends StairsBlock implements IWaterLoggable {
	   ...
	   protected SilverwoodStairs(BlockState state, Block.Properties properties) {
	   ...
	   public static boolean isBlockStairs(BlockState state) {
	      return state.getBlock() instanceof SilverwoodStairs;
	   }
