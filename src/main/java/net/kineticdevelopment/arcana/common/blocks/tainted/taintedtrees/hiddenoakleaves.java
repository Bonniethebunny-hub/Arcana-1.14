...
public class hiddenoakleaves extends Block implements IShearable {
    public static final IntegerProperty DISTANCE = BlockStateProperties.DISTANCE_1_7;
    public static final BooleanProperty PERSISTENT = BlockStateProperties.PERSISTENT;
    protected static boolean renderTranslucent;

    public hiddenoakleaves(Properties properties) {
        super(properties);
        setRegistryName("hiddenoakleaves");
    ...
    private static int getDistance(BlockState neighbor) {
        if (neighbor.getBlock().equals(ModBlocks.DAIRLOG)) {
            ...
            return neighbor.getBlock() instanceof hiddenoakleaves ? neighbor.get(DISTANCE) : 7;
        }
    }
