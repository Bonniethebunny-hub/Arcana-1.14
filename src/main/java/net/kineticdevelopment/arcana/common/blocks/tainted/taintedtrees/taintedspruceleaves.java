...
public class taintedspruceleaves extends Block implements IShearable {
    public static final IntegerProperty DISTANCE = BlockStateProperties.DISTANCE_1_7;
    public static final BooleanProperty PERSISTENT = BlockStateProperties.PERSISTENT;
    protected static boolean renderTranslucent;

    public taintedspruceleaves(Properties properties) {
        super(properties);
        setRegistryName("taintedspruceleaves");
    ...
    private static int getDistance(BlockState neighbor) {
        if (neighbor.getBlock().equals(BlockInit.DAIRLOG)) {
            ...
            return neighbor.getBlock() instanceof taintedspruceleaves ? neighbor.get(DISTANCE) : 7;
        }
    }
