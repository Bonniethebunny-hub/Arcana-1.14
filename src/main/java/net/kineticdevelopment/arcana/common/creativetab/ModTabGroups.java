...
public class ModTabGroups {
    public static final ItemGroup MOD_ITEM_GROUP = new ModTabGroup(Constants.MODID, () -> new ItemStack(ItemInit.THAUMONOMICON)).setBackgroundImageName("item_search.png");
