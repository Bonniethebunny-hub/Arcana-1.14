...
public class TaintedZombie extends MonsterEntity {
    ...
    public void onKillEntity(LivingEntity entityLivingIn) {
        ...
        if ((this.world.getDifficulty() == Difficulty.NORMAL || this.world.getDifficulty() == Difficulty.HARD) && entityLivingIn instanceof VillagerEntity) {
            ...
            zombievillagerentity.onInitialSpawn(this.world, this.world.getDifficultyForLocation(new BlockPos(zombievillagerentity)), SpawnReason.CONVERSION, new TaintedZombie.GroupData(false), null);
    ...
    class AttackTurtleEggGoal extends BreakBlockGoal {
        ...
        public void playBreakingSound(IWorld p_203114_1_, BlockPos p_203114_2_) {
            p_203114_1_.playSound(null, p_203114_2_, SoundEvents.ENTITY_ZOMBIE_DESTROY_EGG, SoundCategory.HOSTILE, 0.5F, 0.9F + TaintedZombie.this.rand.nextFloat() * 0.2F);
        }
