...
public class GluttonyDemon extends CreatureEntity {

    public GluttonyDemon(EntityType<? extends CreatureEntity> type, World worldIn) {
        super((EntityType<? extends CreatureEntity>) EntityInit.GLUTTONYDEMON, worldIn);
    }
