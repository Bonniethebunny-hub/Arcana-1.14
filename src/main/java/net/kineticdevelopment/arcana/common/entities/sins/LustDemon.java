...
public class LustDemon extends CreatureEntity {

    public LustDemon(EntityType<? extends CreatureEntity> type, World worldIn) {
        super((EntityType<? extends CreatureEntity>) EntityInit.LUSTDEMON, worldIn);
    }
