...
public class SlothDemon extends CreatureEntity {

    public SlothDemon(EntityType<? extends CreatureEntity> type, World worldIn) {
        super((EntityType<? extends CreatureEntity>) EntityInit.SLOTHDEMON, worldIn);
    }
