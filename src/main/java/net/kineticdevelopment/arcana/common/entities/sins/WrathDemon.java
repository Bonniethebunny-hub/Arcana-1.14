...
public class WrathDemon extends CreatureEntity {

    public WrathDemon(EntityType<? extends CreatureEntity> type, World worldIn) {
        super((EntityType<? extends CreatureEntity>) EntityInit.WRATHDEMON, worldIn);
    }
